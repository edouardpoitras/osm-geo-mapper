...
pub struct CLIOptions {
    ...
    #[structopt(
        long = "latitude",
        requires("longitude"),
        help = "The latitude that will be used when fetching OpenStreetMap data (ignored if address or PBF/GeoJSON file is provided)"
    )]
    ...
    #[structopt(
        long = "longitude",
        requires("latitude"),
        help = "The longitude that will be used when fetching OpenStreetMap data (ignored if address or PBF/GeoJSON file is provided)"
    )]
    ...
    #[structopt(
        short = "a",
        long = "address",
        help = "The address that will be used when fetching OpenStreetMap data (ignored if PBF/GeoJSON file is provided)"
    )]
